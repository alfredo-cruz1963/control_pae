...
let selectedFaceDetector = TINY_FACE_DETECTOR     //SSD_MOBILENETV1
...
async function changeFaceDetector(detector) {
  ...
  const faceDetectorSelect = TINY_FACE_DETECTOR     //$('#selectFaceDetector')
